...
// code start
 ...
 var sphereShape, sphereBody, world, physicsMaterial, walls=[], balls=[], ballMeshes=[], boxes=[], boxMeshes=[];
            ...
            function init() {
                ...
                var geometry = new THREE.TorusBufferGeometry(1, 1, 1, 1);
                //helooooooooooo
                
                 //end
               // Add boxes
                var halfExtents = new CANNON.Vec3(.4,.4,0.3);
                var boxShape = new CANNON.Box(halfExtents);
                var boxGeometry = new THREE.BoxGeometry(halfExtents.x*2,halfExtents.y*2,halfExtents.z*2);
                var ringGeometry = new THREE.RingGeometry( halfExtents.x*2,halfExtents.y*2,halfExtents.z*2);
                for(var i=0; i<1; i++){
                    var x = 10;
                    var y = 10;
                    var z = 10;
            ...
            var ballGeometry = new THREE.SphereGeometry(ballShape.radius, 4, 32);
